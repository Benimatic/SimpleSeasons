...
@MCVersion(SeasonsLoadingPlugin.MC_VERSION)
@TransformerExclusions({ "com.benimatic.simpleseasons"})
public class SeasonsLoadingPlugin implements IFMLLoadingPlugin {
	...
	public String[] getASMTransformerClass() {
		return new String[] {
				TransformerBiomeBase.class.getName()
		};
	}
